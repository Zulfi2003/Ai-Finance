...
const generatePromptWithMiniModel = async (userId, totalBudget, totalIncome, totalSpend, savingsRate, userQuery) => {
  try {
    ...
    const miniUserPrompt = `
      ...
      Generate a prompt for the gpt-4o-mini model accoridng to the user query.Make it like it just response in 3-4 lines only not descriptive and ask for more detil about a specific topic or area of interest they would like to know make it feel like conversative.dont ask about information you habe already with you.
    `;
